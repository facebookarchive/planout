...
prev: /docs/serializing-experiments.html
---
...
## How the PlanOut interpreter works
Reads in JSON: there are two types:
 - Literals: numbers, booleans, strings
 - Operators: encoded as {'op': 'opname', ...}, where ... are a set of optional
