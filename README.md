...
The reference implementation for PlanOut is written in Python.  It includes:
  * Extensible classes for defining experiments. This class comes with objects that make it easy to implement randomized assignments, and automatically logs key data.
...
Ports of PlanOut, including to PHP, Hack, Ruby, and Go, will be available in the
`alpha/` directory.
